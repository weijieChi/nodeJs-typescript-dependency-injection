...
var UserController = /** @class */ (function () {
    function UserController(userServices) {
        ...
        this.register = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var user, _password, safeUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userServices.register(req.body)];
                    case 1:
                        user = _a.sent();
                        _password = user.password, safeUser = __rest(user, ["password"]);
                        res.json({
        ...
        this.login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userServices.login(req.body)];
                    case 1:
                        user = _a.sent();
                        _password = user.password, safeUser = __rest(user, ["password"]);
                        res.json({
